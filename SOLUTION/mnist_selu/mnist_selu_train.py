...
def main():
    ...
    parser.add_argument('--gpu-device', type=int, default=1, metavar='N',
    ...
    device = torch.device(f"cuda:{args.gpu_device}" if use_cuda else "cpu")
    ...
    if args.save_onnx:
        ...
        torch.onnx.export(model, sample, "mnist_cc.onnx")
